...
from pystorm_a8c.storm import JavaObject, NullStruct, StreamInfo, ThriftGrouping
from pystorm_a8c.dsl.util import to_java_arg
...
class Stream(StreamInfo):
    ...
    def __init__(self, fields=None, name="default", direct=False):
        ...
        if isinstance(direct, bool):
            ...
            raise TypeError(f'"direct" must be either True or False; given: {direct!r}')


class _Grouping(ThriftGrouping):
    """
    Version of the Thrift ``Grouping`` union that has a better __repr__.
    """
